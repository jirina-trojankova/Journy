...
<div class="homepage_top_image jumbotron-fluid">
    <div class="layer">
        <div class="column justify-content-center">
            ...
            <p>Short description: We bridge the gap between travelers, local people, and many of the hot spots & small businesses.
                We provide travelers with a variety of fun options so they can create their own unique travel experience
                steeped in local customs and traditions.</p>
            <p>Beware, this site is still under construction. However, you can review its main features. Start by typing Asia
                in a search bar, or check our Login section</p>
